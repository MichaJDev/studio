...
export default function FeaturedVideoCarouselItem({ video }: FeaturedVideoCarouselItemProps) {
  ...
  return (
    <div className="relative aspect-[16/7] w-full overflow-hidden group"> {/* Wider aspect ratio */}
      {/* Background Image */}
      <Image
        ...
        data-ai-hint={video.dataAiHint || (isShow ? "tv show scene" : "movie scene")}
        priority // Prioritize loading for the main carousel image
      />

      {/* Gradient Overlay */}
      <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent"></div>
       <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-transparent opacity-70"></div> {/* Left fade */}
